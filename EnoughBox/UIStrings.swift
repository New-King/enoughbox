...
enum UIStrings {
  ...
  enum Clipboard {
    ...
    static let settingsHint = "最近按最新复制和浮窗内操作排序，最多 20 条。全部按复制时间排序，最新在前。"
    static let searchPlaceholder = "搜索"
    static let shortcutPaste = "↵ 粘贴"
    static let shortcutMove = "↑↓ 选择"
    static let shortcutCategory = "←→ 分类"
    static let shortcutSearch = "/ 搜索"
